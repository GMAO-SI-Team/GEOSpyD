...
```
./install_miniforge.bash --python_version 3.14 --miniforge_version 26.5.3-0 --prefix /opt/GEOSpyD
```

will create an install at:
```text
/opt/GEOSpyD/26.5.3-0/YYYY-MM-DD
```
...
Usage: ./install_miniforge.bash --python_version <python version> --miniforge_version <miniforge> --prefix <prefix>
   ...
   Required arguments:
      ...
      --miniforge_version <miniforge_version version> (e.g., 26.5.3-0)
   ...
   For example: ./install_miniforge.bash --python_version 3.14 --miniforge_version 26.5.3-0 --prefix /opt/GEOSpyD

   will create an install at:
       /opt/GEOSpyD/26.5.3-0/2026-03-11
